...
einzuhaltende_kalorien = 700    #import of the snack should be the value the user has per snack. If you have 900kcal for snacks and want to eat
# three snacks, than the amount per snack is 300.
...
def import_recipe():
    ...
    ingredients = "SELECT ingredients FROM breakfast_recipes WHERE rowid=?"
